...
const SELECT_WITH_RELATIONS =
  '*, chalet:chalets(id, nombre, slug), huesped:huespedes(id, nombre, apellidos, telefono, email, whatsapp_valido), creador:usuarios!reservas_creada_por_fkey(id, nombre)';
